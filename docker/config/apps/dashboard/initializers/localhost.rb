...
Rails.application.config.after_initialize do
  ...
  class OodCore::Job::Factory
    ...
    def self.build(config)
      ...
      adapter = c.fetch(:adapter) do
        raise AdapterNotSpecified, 'job configuration does not specify adapter'
      end.to_s
      ...
      begin
        ...
        raise Gem::LoadError,
              "Specified '#{adapter}' for job adapter, but the gem is not loaded."
      rescue LoadError
        raise LoadError,
